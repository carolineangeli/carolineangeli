...
Desenvolvedora em formação, apaixonada por tecnologia e focada em construir soluções utilizando **TypeScript**.

Após atuar em Engenharia de Qualidade de Software, estou direcionando minha carreira para Desenvolvimento, aplicando minha experiência em qualidade, testes e resolução de problemas para construir aplicações mais robustas.
